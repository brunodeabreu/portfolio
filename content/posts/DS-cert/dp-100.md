...
Este é o primeiro post de anotações que fiz durante o curso preparatório para certificação **DP-100**, esta parte contém informações para configurar o ambiente de machine learning na cloud da Microsoft Azure e no ambiente _AzureML_.

Para obter o certificado [Exam DP-100: Designing and Implementing a Data Science Solution on Azure](https://docs.microsoft.com/en-us/learn/certifications/exams/dp-100) temos o plano de estudo _free_ criado pela microsoft que descreve [Criar soluções de IA com o Azure Machine Learning](https://docs.microsoft.com/pt-br/learn/paths/build-ai-solutions-with-azure-ml-service/), que é composto de 14 módulos, aproximadamente 14hrs de estudo.

As anotações abaixo foram retiradas do curso preparatório que fiz pela TIDWIT.
...
- Precisa garantir que a **Region** tem os recursos que precisa, nem todas tem GPU.
...
Outra opção é utilizar Visual Studio ou alguma IDE com publing da AzureML:
